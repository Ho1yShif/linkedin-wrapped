...
- Eliminate the Python backend for LinkedIn wrapped and perform all logic in Typescript in the frontend
- Show one piece of information at a time and make it sharable like Spotify wrapped
